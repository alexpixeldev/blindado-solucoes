...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($usuario && password_verify($senha, $usuario['senha'])) {
        ...
        $cat_original = strtolower(trim($usuario['categoria']));
        $_SESSION['usuario_categoria_real'] = $cat_original;
        $_SESSION['usuario_categoria'] = categoria_grupo($cat_original);
