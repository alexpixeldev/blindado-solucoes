                                    ...
                                    <div class="relative">
                                        <select name="categoria" class="form-input appearance-none pr-10" required <?= $usuario_categoria === 'supervisor' ? 'disabled' : '' ?>>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <option value="gerente_monitoramento" <?= $usuario['categoria'] == 'gerente_monitoramento' ? 'selected' : '' ?>>Gerente Monitoramento</option>
                                                <option value="gerente_zeladoria" <?= $usuario['categoria'] == 'gerente_zeladoria' ? 'selected' : '' ?>>Gerente Zeladoria</option>
