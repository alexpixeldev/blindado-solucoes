...
// Normaliza categorias novas em grupos existentes (sessões criadas antes do agrupamento)
if (!isset($_SESSION['usuario_categoria_real']) && in_array($_SESSION['usuario_categoria'] ?? '', ['gerente_monitoramento', 'gerente_zeladoria', 'gerente_tecnica', 'supervisor_zeladoria'])) {
    $_SESSION['usuario_categoria_real'] = $_SESSION['usuario_categoria'];
    $_SESSION['usuario_categoria'] = categoria_grupo($_SESSION['usuario_categoria']);
}
