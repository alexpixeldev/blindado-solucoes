                    ...
                    <div class="admin-card">
                        <form method="POST" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div class="pt-6 border-t border-slate-100 flex flex-col sm:flex-row gap-3">
                                <button type="submit" class="icon-btn-green" title="Enviar Contracheque"><i class="fas fa-upload" style="font-size:10px"></i></button>
                                <a href="visualizar_colaborador.php?id=<?= $id ?>" class="icon-btn" title="Cancelar"><i class="fas fa-times" style="font-size:10px"></i></a>
                            </div>
                        </form>
                    </div>
                </div>
