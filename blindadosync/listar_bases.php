            ...
            <main class="flex-1 overflow-y-auto p-4 sm:p-8 custom-scrollbar">
                ...
                <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between animate-fade-in">
                    ...
                    <div class="flex gap-2">
                        <a href="cadastrar_base.php" class="icon-btn-green" title="Nova Base"><i class="fas fa-plus" style="font-size:10px"></i></a>
                    </div>
                </div>
                                            ...
                                            <td class="text-right">
                                                <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                    ...
                                                    <form method="POST" onsubmit="return confirm('ATENÇÃO! Excluir uma base também apaga TODOS os seus edifícios (<?= $base['total_edificios'] ?> edifício(s)). Tem certeza?');" class="inline">
                                                        ...
                                                        <button type="submit" name="delete_base" class="icon-btn-red" title="Excluir"><i class="fas fa-trash-alt" style="font-size:10px"></i></button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
