        ...
        <div class="flex flex-1 flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-4 sm:p-8 custom-scrollbar">
                ...
                <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between animate-fade-in">
                    ...
                    <a href="cadastrar_edificio.php" class="icon-btn-green" title="Novo Edifício"><i class="fas fa-plus" style="font-size:10px"></i></a>
                </div>
                                        ...
                                        <tr class="group">
                                            ...
                                            <td class="text-right">
                                                <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                    <a href="editar_edificio.php?id=<?= $edificio['id'] ?>" class="icon-btn" title="Editar"><i class="fas fa-edit" style="font-size:10px"></i></a>
                                                    <form method="POST" onsubmit="return confirm('Deseja realmente excluir este edifício?');" class="inline">
                                                        ...
                                                        <button type="submit" name="delete_edificio" class="icon-btn-red" title="Excluir"><i class="fas fa-trash-alt" style="font-size:10px"></i></button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
