            ...
            <main class="flex-1 overflow-y-auto p-4 sm:p-8 custom-scrollbar">
                ...
                <div class="mb-8 animate-fade-in max-w-3xl mx-auto">
                    <div class="flex items-center gap-4">
                        <a href="ver_faltas.php?id=<?= $falta['usuario_id'] ?>" class="icon-btn" title="Voltar"><i class="fas fa-arrow-left" style="font-size:10px"></i></a>
                        <div>
                            ...
                            <div class="space-y-4 pt-4 border-t border-slate-100">
                                <div class="flex items-center justify-between">
                                    ...
                                    <?php if ($falta['arquivo']): ?>
                                        <a href="../uploads/faltas/<?= htmlspecialchars($falta['arquivo']) ?>" target="_blank" class="icon-btn-blue" onmouseover="this.style.background='#2563eb'" onmouseout="this.style.background='#3b82f6'" title="Visualizar"><i class="fas fa-external-link-alt" style="font-size:10px"></i></a>
                                    <?php endif; ?>
                                </div>
