                    ...
                    <div class="admin-card">
                        <form method="GET" class="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:items-end">
                            ...
                            <div class="flex gap-2">
                                <button type="submit" class="icon-btn" title="Filtrar"><i class="fas fa-filter" style="font-size:10px"></i></button>
                                <a href="meus_contracheques.php" class="icon-btn" title="Limpar Filtros"><i class="fas fa-sync-alt" style="font-size:10px"></i></a>
                            </div>
                        </form>
                    </div>
                </div>
                                        ...
                                        <?php foreach ($contracheques as $cc): ?>
                                            <tr class="group">
                                                ...
                                                <td class="text-center">
                                                    <a href="../uploads/contracheques/<?php echo htmlspecialchars($cc['arquivo']); ?>" target="_blank" class="icon-btn-blue" onmouseover="this.style.background='#2563eb'" onmouseout="this.style.background='#3b82f6'" title="Visualizar / Baixar">
