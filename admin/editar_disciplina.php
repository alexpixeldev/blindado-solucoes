            ...
            <main class="flex-1 overflow-y-auto p-4 sm:p-8 custom-scrollbar">
                ...
                <div class="mb-8 animate-fade-in max-w-3xl mx-auto">
                    <div class="flex items-center gap-4">
                        <a href="ver_disciplina.php?id=<?= $acao['usuario_id'] ?>" class="icon-btn" title="Voltar"><i class="fas fa-arrow-left" style="font-size:10px"></i></a>
                        <div>
                        ...
                        <form method="POST" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div class="space-y-4 pt-4 border-t border-slate-100">
                                <div class="flex items-center justify-between">
                                    ...
                                    <?php if ($acao['arquivo']): ?>
                                        <a href="../uploads/disciplina/<?= htmlspecialchars($acao['arquivo']) ?>" target="_blank" class="icon-btn-blue" onmouseover="this.style.background='#2563eb'" onmouseout="this.style.background='#3b82f6'" title="Visualizar"><i class="fas fa-external-link-alt" style="font-size:10px"></i></a>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="pt-6 border-t border-slate-100 flex flex-col sm:flex-row gap-3">
                                ...
                                <a href="ver_disciplina.php?id=<?= $acao['usuario_id'] ?>" class="icon-btn" title="Cancelar"><i class="fas fa-times" style="font-size:10px"></i></a>
                            </div>
                        </form>
                    </div>
                </div>
