...
<head>
    ...
    <title>Gestão de Faltas | Blindado Soluções</title>
        ...
        <div class="flex flex-1 flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-4 sm:p-8 custom-scrollbar">
                ...
                <div class="mb-8 animate-fade-in">
                    <h1 class="text-2xl font-bold text-slate-900 sm:text-3xl">Gestão de Faltas</h1>
                    <p class="mt-1 text-slate-500">Gerencie e registre as faltas dos colaboradores da empresa.</p>
                </div>
                ...
                <div class="mb-6 animate-slide-up">
                    <div class="admin-card">
                        ...
                        <?php if ($search): ?>
                            <a href="gestao_faltas.php" class="btn-secondary mt-4" title="Limpar Filtros">
                                ...
                                <?php else: ?>
                                    <?php foreach ($colaboradores as $colab): ?>
                                        <tr class="group">
                                            ...
                                            <td class="text-right">
                                                <a href="registrar_falta.php?id=<?= $colab['id'] ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-primary-50 text-primary-700 rounded-xl font-bold text-xs hover:bg-primary-600 hover:text-white transition-all">
