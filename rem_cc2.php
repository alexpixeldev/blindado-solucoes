...
$sql = "SELECT * FROM usuarios WHERE categoria NOT IN ('gerente', 'gerente_monitoramento', 'gerente_zeladoria', 'gerente_tecnica', 'administrativo', 'supervisor', 'supervisor_zeladoria')";
