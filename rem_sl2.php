...
// Mapeamento de categorias novas para o grupo (permissões) que usamos hoje
function categoria_grupo($cat) {
    if (in_array($cat, ['gerente_monitoramento', 'gerente_zeladoria', 'gerente_tecnica'])) return 'gerente';
    if ($cat === 'supervisor_zeladoria') return 'supervisor';
    return $cat;
}

function categoria_label($cat) {
    $map = [
        'gerente' => 'Gerente',
