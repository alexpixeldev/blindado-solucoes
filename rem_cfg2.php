...
define('USER_ROLES', [
    ...
    'gerente' => 'Gerente',
    'gerente_monitoramento' => 'Gerente Monitoramento',
    'gerente_zeladoria' => 'Gerente Zeladoria',
    'gerente_tecnica' => 'Gerente Técnica',
...
define('PERMISSIONS', [
    ...
    'gerente_monitoramento' => ['manage_users', 'manage_data', 'view_reports', 'delete_records'],
    'gerente_zeladoria' => ['manage_users', 'manage_data', 'view_reports', 'delete_records'],
    'gerente_tecnica' => ['manage_users', 'manage_data', 'view_reports', 'delete_records'],
    'supervisor' => ['manage_data', 'view_reports'],
    'supervisor_zeladoria' => ['manage_data', 'view_reports'],
