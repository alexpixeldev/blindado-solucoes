...
function btnAbrir($valor) {
    ...
    return '<a href="' . htmlspecialchars($link) . '" target="_blank" class="icon-btn-blue" onmouseover="this.style.background=\'#2563eb\'" onmouseout="this.style.background=\'#3b82f6\'" title="Abrir: ' . htmlspecialchars($link) . '"><i class="fas fa-external-link-alt" style="font-size:10px"></i></a>';
}
                                    ...
                                    <div class="loc-card-header">
                                        ...
                                        <?php if ($pode_editar): ?>
                                            <div class="flex gap-1 shrink-0">
                                                <a href="editar_dados.php?tipo=<?= $tipo_dados ?>&id=<?= $row['id'] ?>" class="icon-btn" title="Editar"><i class="fas fa-edit" style="font-size:10px"></i></a>
